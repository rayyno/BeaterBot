...
client.on('message', message => {
	...
	if (message.content === 'مين ابو مروه') {
       message.reply('أبو مروه, مروان بن جرمان بن جهيمان (المتوفي سنة 59 هـ/678م) صحابي محدث وفقيه في سيرفر البيتميترز وحافظ لجميع بيلدات التفت سنة 7 هـ، ولزم دامبا جوس وتعلم منه وحفظ الحديث عنه، حتى أصبح أكثر الصحابة روايةً وحفظاً لاستراتيجات التفت. تعلم طب النفس في ولاية الكوفة في السنة الثامنه من الهجرة. شارك في معركة وغزوة الاجرامية. تولى امارة قناة هرمز. توفي في السنة 59 من الهجرة');
       }
